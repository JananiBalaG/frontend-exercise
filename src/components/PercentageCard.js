  ...
  export default class PercentageCard {
    ...
    getElement() {
      ...
      //creating an onclick event to open a wikipage explaining customer retention.
      card.addEventListener("click", function() 
      {
        //the click event will open a wiki page explaining what customer retention is.
        window.open('https://en.wikipedia.org/wiki/Customer_retention');
      }    
